...
public class _EppdevColumn extends BasicEntity {
    ...
    // static properties for sort_by
    public static final String COLUMN_SORT_BY_ = "sort_by";
    public static final String COLUMN_SORT_BY_ASC_ = "sort_by asc";
    public static final String COLUMN_SORT_BY_DESC_ = "sort_by desc";
